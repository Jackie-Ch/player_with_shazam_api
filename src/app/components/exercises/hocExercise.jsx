  ...
  return (
    <CollapseWrapper title="Упражнение">
      ...
      <ul>
        ...
        <li>
          Отображате кноку <code>Войти</code>, если пользователь НЕ авторизован
        </li>
        <li>
      ...
      <ul>
        <li>
          Добавляет обертку в виде карточки boostrap (использовать существующией
          HOC)
        </li>
        <li>
          Передает параметр <code>isAuth</code>, который является резльтатом
