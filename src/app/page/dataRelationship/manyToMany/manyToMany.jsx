...
const ManyToManyPage = () => {
  return (
    <>
      ...
      <Text>- В каждом теге храним ссылки на все книги, содержащие тег.</Text>
      ...
      <Text>
        Overload - перегрузка, сверхнагрузка. В данном случае имеется ввиду
        хранение большого количества даннных в параметре определенного
        экземпляра сущности.
      </Text>
