  ...
  return (
    <>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>
            Избыточность данных - это условие, создаваемое в базе данных или
            технологии хранения данных, при которой один и тот же фрагмент
            данных хранится в двух разных местах.
            <br />
            Это может означать два разных поля в одной базе данных или два
            разных места в нескольких программных средах или платформах. Всякий
            раз, когда данные повторяются, это представляет собой избыточность
            данных.
          </Typography>
        </AccordionDetails>
      </Accordion>
      ...
      <Text>
        Денормализация - это метод, который используется при проектировании в
        базе данных. Он используется для добавления избыточности для быстрого
        выполнения запроса. Это метод, при котором данные объединяются.
      </Text>

      <SmallTitle>Характеристики</SmallTitle>
      <Stack direction="row" spacing={1} style={{ margin: "10px 0 20px" }}>
        <Chip
      ...
      <Text>
        Нормализация - это метод, используемый в базе данных для уменьшения
        избыточности и несогласованности данных. Это метод, при котором данные
        без избыточности и непротиворечивости хранятся в установленной схеме.
      </Text>
      <SmallTitle>Характеристики</SmallTitle>
      <Stack direction="row" spacing={1} style={{ margin: "10px 0 20px" }}>
        <Chip
        ...
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="center">Denormalization</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {rows.map((row) => (
              ...
              >
                ...
                <TableCell align="center">{row.denorm}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
